export const worldMarkers = [
    {
        ...
        mobileLeft: '25%', // Mobile-specific position
        number: '73',
        ...
        hotspotColor: '#E04F16',
        mapImage: '/images/america-map.png'
    },
    {
        id: 2,
        slug: 'europe',
        ...
        mobileLeft: '38%', // Mobile-specific position
        number: '55',
        title: 'Europe Conflict Index',
        description: 'An aggregated, data-driven estimate of the likelihood of significant geopolitical or military conflict across North, Central, and South America, derived from active prediction market contracts and exchange signals.',
        tags: ['War', 'Europe', 'Ukraine', 'Russia', '+3'],
        hotspotColor: '#F7B27A',
        mapImage: '/images/europe-map.png'
    },
    {
        id: 3,
        slug: 'africa',
        ...
        mobileLeft: '55%', // Mobile-specific position
        number: '35',
        title: 'Africa Conflict Index',
        description: 'An aggregated, data-driven estimate of the likelihood of significant geopolitical or military conflict across North, Central, and South America, derived from active prediction market contracts and exchange signals.',
        tags: ['War', 'Europe', 'Ukraine', 'Russia', '+3'],
        hotspotColor: '#B93815',
        mapImage: '/images/africa-map.png'
    },
    {
        id: 4,
        slug: 'asia',
    ...
    },
    {
        ...
        tags: ['War', 'Europe', 'Ukraine', 'Russia', '+3'],
        hotspotColor: '#F38744',
        mapImage: '/images/middle-east.webp'
    },
    {
        id: 6,
        slug: 'oceania',
        ...
        tags: ['War', 'Europe', 'Ukraine', 'Russia', '+3'],
        hotspotColor: '#F38744',
        mapImage: '/images/oceania-map.png'
    }
];
