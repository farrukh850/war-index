...
const WorldContent = ({ markers, activeMarker, setActiveMarker, popupRef }) => {
    return (
        <div className="grid grid-cols-12 gap-5 lg:gap-11 justify-between pb-11">
            <div className="col-span-12 lg:col-span-9">
                <div className="flex flex-col gap-0.5 mb-5 lg:mb-11">
                    <h3 className="text-2xl text-text-primary font-semibold">Asia Conflict Index</h3>
                    <p className="text-base text-text-tertiary">A summary or description can go here</p>
                </div>
                <div className="flex-col gap-1 flex lg:hidden mb-6">
                    <p className="text-sm text-bg-active">Powered by</p>
                    <img src="/images/micah.svg" className="w-30" alt="Micah"/>
                </div>
                <div className="relative">
                    <img src="/images/asia-map.png" alt="Map" className="w-full"/>
                    {markers.map(marker => (
                        <button
                            key={marker.id}
                            className="w-1 h-1 md:w-2.5 md:h-2.5 rounded-full bg-utility-orange absolute animate-pulse-glow cursor-pointer marker-button"
            ...
            <div className="col-span-12 lg:col-span-3">
                ...
                <div className="grid grid-cols-12 gap-4 mt-5 lg:mt-11 w-full lg:max-w-[367px]">
                    <div className="col-span-12 lg:col-span-12 flex flex-col text-center p-3 rounded-2xl bg-light-yellow items-center justify-center">
                        <h4 className="text-[40px] font-bold text-dark-primary">33</h4>
                        <div className="flex items-center gap-1">
                            <p className="text-base text-dark-primary font-medium">PMI Score</p>
                            <img src="/images/info-circle.svg" alt="Info Icon"/>
                        </div>
                    </div>
                    <div className="col-span-6 lg:col-span-12 flex flex-col text-center p-3 rounded-2xl bg-transparent items-center justify-center border border-utility-gray">
                    ...
                    <div className="col-span-12 lg:col-span-12 flex flex-col gap-2 text-center p-3 rounded-2xl bg-transparent items-center justify-center border border-utility-gray">
